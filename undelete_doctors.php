    	...
    	<div class="col-sm-12">
        	<div class="header bg-white">
                    ...
                    <span id="blinker"><span style="font-size:15px; color:white";><?php
                                  ...
                                  echo $new;
      							?></span></span>
	 <span style="margin-left:230px; font-size:30px;">** Hospital Management **</span>
    ...
    <div class="row">
    	<div class="col-sm-12">
        	<div class="footer bg-#990000">
            	<div class="copyright">
                	<p align="center" style="padding-top:10px;color:white">Copyright &copy;   &nbsp;&nbsp;&nbsp;<span style="color:#CC0033">tanmayhstu103@gmail.com</span></p>
                </div>
            </div>
        </div>
    </div>
